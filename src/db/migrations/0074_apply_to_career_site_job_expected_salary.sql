-- Suma la pretensión salarial (opcional) que el candidato puede declarar al postularse.
-- Mismo cuerpo que la 0056 + los dos parámetros nuevos, con default null para no romper
-- a nadie que siga llamando la función con la firma vieja.

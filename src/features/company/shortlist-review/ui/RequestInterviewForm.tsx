...
import { MAX_INTERVIEW_SLOTS } from "../domain/interview-slots";
...
/** Hasta 3 horarios tentativos para pedir entrevista — ver `parseInterviewSlots`. Una vez
 *  solicitada, el sheet muestra los horarios propuestos (ver `ShortlistCandidateDetailSheet`),
 *  este form ya no se renderiza. */
export function RequestInterviewForm({ token, shortlistCandidateId, requested }: Props) {

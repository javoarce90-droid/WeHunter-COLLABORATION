...
import { deriveBrandVars } from "@/features/candidate/career-site/ui/brand";
...
export default async function CareerSiteLayout({
  ...
  // El branding del workspace (Fase 2) sobreescribe --primary* para toda esta subtree: cada
  // Career Site se ve con SU color, no con el purple de WeHunter. Ver ui/brand.ts.
  const brandVars = deriveBrandVars(careerSite.settings?.primaryColor);

  return (
    <div className="min-h-dvh bg-bg" style={brandVars as React.CSSProperties}>

      ...
      <div className="footer-grid">
        <div className="footer-left">
          ...
          <div className="footer-mission" style={{ marginTop: 14 }}>
            ...
            Dejá que WeHunter se ocupe de la operación para que vos puedas
            enfocarte en lo que realmente importa: las personas.
            <br />
            <br />
        ...
        >
          <div className="footer-nav-cols">
            <div className="footer-col">
              ...
              <a href="#mucho-mas-ats">Soluciones</a>
              <a href="#demo">Demo</a>
            </div>
            <div className="footer-col">
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-inner">
          ...
          <div className="footer-tag">
            Diseñado por recruiters para recruiters.
          </div>
        </div>
      </div>
    </footer>

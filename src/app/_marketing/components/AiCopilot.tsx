      ...
      >
        <Reveal>
          ...
          <div className="sec-sub">
            Mientras te enfocás en las conversaciones y las decisiones, tu
            copiloto evalúa candidatos, redacta informes, genera estrategias de
            sourcing y prepara mensajes personalizados. Siempre con tu criterio
            al mando.
          </div>
          ...
          <div className="sol-cta">
            <GoDemoTabLink tab="asistente">
              Hablá con el asistente en la demo →
            </GoDemoTabLink>
          </div>
        </Reveal>
        <Reveal className="sol-visual">
          <div className="mini-mock">
            ...
            >
              18 días activa · 6 candidatos en juego. Lucas tiene entrevista
              mañana y Diego espera respuesta de oferta hace 3 días.{" "}
...
//   return (
//     <section className="alt">
//       {/* Reemplazamos los estilos inline por la clase sol-block */}
//       <div className="sec sol-block">
//         <Reveal>
//           <div className="sec-title">
//             La IA trabaja.
//             <br />
...
//                 fontSize: 12,
//                 marginBottom: 10,
//                 marginLeft: "auto", // Ajuste responsive para la burbuja del usuario
//                 maxWidth: "85%",
//               }}
//             >
//               Resumime el pipeline de Acme Corp
